            ...
            {days.map((day: Day) => (
              ...
              >
                ...
                <ol className='mt-4 animate-pulse'>
                  <li className='group flex mt-2 h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-full' />
                  <li className='group flex mt-4 mb-2 h-2 bg-gray-300 rounded-full dark:bg-gray-600 w-full' />
                </ol>
              </div>
            ))}
          </div>
