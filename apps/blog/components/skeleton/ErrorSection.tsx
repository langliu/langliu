        ...
        <Container className='mt-9'>
          ...
          >
            ...
            <div className='mt-2 mb-4 text-sm text-gray-700 dark:text-gray-300'>
              Was not able to fetch the data for this section. You can continue browsing the site,
              but this section will not be available. You can try reloading the page to see if the
              issue is resolved.
            </div>
            <div className='flex'>
              <button
