...
import { GitHubIcon, GoogleScholarIcon, LinkedInIcon, TwitterIcon } from 'components/SocialIcons'
    ...
    <Container className='mt-9'>
      <div className='max-w-3xl'>
        ...
        <h2 className='text-gray-600 dark:text-gray-400 tracking-tighter mb-4'>
          ...
          <Link className='font-semibold' href={about.company.url} target={'_blank'}>
            {about.company.name}
          </Link>
        </h2>
        <p
